  ...
  if(ThisTask == 0)		/* read parameter file on process 0 */
    {
      ...
      strcpy(tag[nt], "FdmAxionMass");
      addr[nt] = &All.FdmAxionMass;
      id[nt++] = DOUBLE;
      
      strcpy(tag[nt], "FdmNormMass");
      addr[nt] = &All.FdmNormMass;
      id[nt++] = DOUBLE;
      
      strcpy(tag[nt], "FdmKernelLambda");
      addr[nt] = &All.FdmKernelLambda;
      id[nt++] = DOUBLE;
