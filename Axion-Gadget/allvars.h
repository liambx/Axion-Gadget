...
#ifdef FDM
extern double QuanKickTable[DRIFT_TABLE_LENGTH];      /*!< table for the cosmological kick factor for quantum pressure */
#endif
...
extern struct global_data_all_processes
{
  ...
  /* FDM parameters */
  double FdmAxionMass;        /*!Axion mass in the unit of 10^-22 eV*/
  double FdmNormMass;         /*!Fdm calculation normalization mass in the unit of 10^10 Solar Mass*/
  double FdmKernelLambda;     /*!Fdm Gaussian kernel size, related to the wavelength of the axion, in the unit of kpc*/
}
